...
export const data = new SlashCommandBuilder()
    ...
    .addUserOption(option => option.setName('user').setDescription('The user to assign the toon to').setRequired(true))
...
export const execute = async (interaction) => {
    try {
        ...
        let status = options.get('status')?.value;
        const discordId = options.get('user')?.value;
