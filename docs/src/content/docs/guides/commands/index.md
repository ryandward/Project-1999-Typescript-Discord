...
description: Overview of all slash commands in the Project 1999 Discord bot.
---

Every slash command available in the Project 1999 bot, organized by category. Commands marked **(Officer)** require `ManageGuild` or `ManageRoles` permissions.
